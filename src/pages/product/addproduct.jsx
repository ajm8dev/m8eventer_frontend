...
const Productadd =() => {
    ...
    const submitProductDetails = async (res)=>{
        ...
        const editupdateurl = config.apibaseurl+"/api/product/";
        const configdata = {
            headers: {      
        ...
        axios.post(editupdateurl, editdata, configdata).then(ondataSuccess, ondataFailure); 
    }
            ...
            <main className="main-content position-relative border-radius-lg ">
                ...
                <div class="row">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="row">
                            <div class="text-end">
                                <button type="button" onClick={handleProsubmit} class="btn btn-primary btn-sm ms-auto mt-5">Submit</button>
                            </div>
                        </div>
                        </div>
                    </div>
